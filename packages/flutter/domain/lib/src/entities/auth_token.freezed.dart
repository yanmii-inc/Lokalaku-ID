...
mixin _$AuthToken {
  ...
  $AuthTokenCopyWith<AuthToken> get copyWith => throw _privateConstructorUsedError;
}
...
/// @nodoc
class _$AuthTokenCopyWithImpl<$Res, $Val extends AuthToken> implements $AuthTokenCopyWith<$Res> {
...
/// @nodoc
abstract class _$$AuthTokenImplCopyWith<$Res> implements $AuthTokenCopyWith<$Res> {
  factory _$$AuthTokenImplCopyWith(_$AuthTokenImpl value, $Res Function(_$AuthTokenImpl) then) =
...
/// @nodoc
class __$$AuthTokenImplCopyWithImpl<$Res> extends _$AuthTokenCopyWithImpl<$Res, _$AuthTokenImpl>
    implements _$$AuthTokenImplCopyWith<$Res> {
  __$$AuthTokenImplCopyWithImpl(_$AuthTokenImpl _value, $Res Function(_$AuthTokenImpl) _then)
      : super(_value, _then);
...
class _$AuthTokenImpl extends _AuthToken {
  ...
  factory _$AuthTokenImpl.fromJson(Map<String, dynamic> json) => _$$AuthTokenImplFromJson(json);
  ...
  @override
  String toString() {
    return 'AuthToken(accessToken: $accessToken, refreshToken: $refreshToken, expiresIn: $expiresIn, tokenType: $tokenType, issuedAt: $issuedAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, accessToken, refreshToken, expiresIn, tokenType, issuedAt);
...
abstract class _AuthToken extends AuthToken {
  const factory _AuthToken(
      ...
      @JsonKey(name: 'issued_at') final DateTime? issuedAt}) = _$AuthTokenImpl;
  const _AuthToken._() : super._();

  factory _AuthToken.fromJson(Map<String, dynamic> json) = _$AuthTokenImpl.fromJson;
  ...
  @override
  @JsonKey(includeFromJson: false, includeToJson: false)
  _$$AuthTokenImplCopyWith<_$AuthTokenImpl> get copyWith => throw _privateConstructorUsedError;
}
